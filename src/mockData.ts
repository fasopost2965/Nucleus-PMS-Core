...
export const mockRooms: IRoom[] = [
  ...
  },
  {
    ...
    current_status: 'Libre',
    housekeeping_status: 'À nettoyer',
    maintenance_status: 'Résolu'
  },
  {
    id: 'room-104',
...
export const mockGuests: IGuest[] = [
  { id: 'guest-1', first_name: 'Amadou', last_name: 'Kouassi', gender: 'M', birth_date: '1985-04-12', nationality: 'Ivoirienne', phone: '+225 07 45 89 12 34', email: 'amadou.kouassi@gmail.com', address: 'Quartier Commerce, Bouaké', document_type: 'CNI', document_number: 'CI003489249', vip: true, blacklist: false, guest_type: 'Entreprise', company_name: 'Orange Côte d\'Ivoire', tax_id: 'CI-ABJ-2026-B-1234', deferred_payment_authorized: true, payment_terms: '30 Jours Fin de Mois', credit_limit: 1500000 },
  { id: 'guest-2', first_name: 'Mariam', last_name: 'Bamba', gender: 'F', birth_date: '1992-09-22', nationality: 'Ivoirienne', phone: '+225 05 01 23 45 67', email: 'm.bamba@outlook.com', address: 'Cocody Angré, Abidjan', document_type: 'Passeport', document_number: '12AA9045', vip: false, blacklist: false, guest_type: 'Individuel' },
  { id: 'guest-3', first_name: 'Jean-Pierre', last_name: 'Duval', gender: 'M', birth_date: '1978-11-05', nationality: 'Française', phone: '+33 6 12 34 56 78', email: 'jp.duval@yahoo.fr', address: 'Marcory Zone 4, Abidjan', document_type: 'Passeport', document_number: 'FR843924', vip: true, blacklist: false, guest_type: 'Corporate', company_name: 'SND Côte d\'Ivoire', tax_id: 'CI-BKE-2026-M-4321', deferred_payment_authorized: true, payment_terms: '15 Jours Net', credit_limit: 3000000 },
  { id: 'guest-4', first_name: 'Fatoumata', last_name: 'Diallo', gender: 'F', birth_date: '1995-07-15', nationality: 'Guinéenne', phone: '+225 01 77 88 99 00', email: 'fatou.diallo@gmail.com', address: 'Quartier Kennedy, Bouaké', document_type: 'CNI', document_number: 'GN0934823', vip: false, blacklist: false, guest_type: 'Individuel' },
  { id: 'guest-5', first_name: 'Yao', last_name: 'Koné', gender: 'M', birth_date: '1980-02-28', nationality: 'Ivoirienne', phone: '+225 07 11 22 33 44', email: 'koney@hotmail.fr', address: 'N\'Gattakro, Bouaké', document_type: 'Permis', document_number: 'CI320494', vip: false, blacklist: true, guest_type: 'Individuel' }
];
...
export const mockStockItems: IStockItem[] = [
  ...
  // Clean Linen
  { id: 'stk-3', sku: 'DRAP-CTN-PROP', name: 'Draps Plat Coton (Linge Propre)', category_id: 'Linge Propre', supplier_id: 'sup-2', purchase_price: 8500, selling_price: 0, unit: 'Pièce', minimum_stock: 25, current_stock: 30 },
  { id: 'stk-5', sku: 'COUV-SAT-PROP', name: 'Couvre-lits Satin (Linge Propre)', category_id: 'Linge Propre', supplier_id: 'sup-2', purchase_price: 12000, selling_price: 0, unit: 'Pièce', minimum_stock: 15, current_stock: 18 },
  { id: 'stk-6', sku: 'TAIE-CTN-PROP', name: 'Taies d\'oreiller Coton (Linge Propre)', category_id: 'Linge Propre', supplier_id: 'sup-2', purchase_price: 2500, selling_price: 0, unit: 'Pièce', minimum_stock: 40, current_stock: 45 },
  { id: 'stk-7', sku: 'SERV-BAIN-PROP', name: 'Serviettes de bain (Linge Propre)', category_id: 'Linge Propre', supplier_id: 'sup-2', purchase_price: 5000, selling_price: 0, unit: 'Pièce', minimum_stock: 30, current_stock: 32 },

  // Dirty Linen / Laundry
  { id: 'stk-3-sale', sku: 'DRAP-CTN-SALE', name: 'Draps Plat Coton (Linge Sale / Buanderie)', category_id: 'Linge Sale (Buanderie)', supplier_id: 'sup-2', purchase_price: 8500, selling_price: 0, unit: 'Pièce', minimum_stock: 0, current_stock: 12 },
  { id: 'stk-5-sale', sku: 'COUV-SAT-SALE', name: 'Couvre-lits Satin (Linge Sale / Buanderie)', category_id: 'Linge Sale (Buanderie)', supplier_id: 'sup-2', purchase_price: 12000, selling_price: 0, unit: 'Pièce', minimum_stock: 0, current_stock: 6 },
  { id: 'stk-6-sale', sku: 'TAIE-CTN-SALE', name: 'Taies d\'oreiller Coton (Linge Sale / Buanderie)', category_id: 'Linge Sale (Buanderie)', supplier_id: 'sup-2', purchase_price: 2500, selling_price: 0, unit: 'Pièce', minimum_stock: 0, current_stock: 14 },
  { id: 'stk-7-sale', sku: 'SERV-BAIN-SALE', name: 'Serviettes de bain (Linge Sale / Buanderie)', category_id: 'Linge Sale (Buanderie)', supplier_id: 'sup-2', purchase_price: 5000, selling_price: 0, unit: 'Pièce', minimum_stock: 0, current_stock: 10 },

  // Active in Rooms (for audit)
  { id: 'stk-3-chambre', sku: 'DRAP-CTN-CHMB', name: 'Draps Plat Coton (En Chambre)', category_id: 'Linge en Chambre', supplier_id: 'sup-2', purchase_price: 8500, selling_price: 0, unit: 'Pièce', minimum_stock: 11, current_stock: 11 },
  { id: 'stk-5-chambre', sku: 'COUV-SAT-CHMB', name: 'Couvre-lits Satin (En Chambre)', category_id: 'Linge en Chambre', supplier_id: 'sup-2', purchase_price: 12000, selling_price: 0, unit: 'Pièce', minimum_stock: 11, current_stock: 11 },
  { id: 'stk-6-chambre', sku: 'TAIE-CTN-CHMB', name: 'Taies d\'oreiller Coton (En Chambre)', category_id: 'Linge en Chambre', supplier_id: 'sup-2', purchase_price: 2500, selling_price: 0, unit: 'Pièce', minimum_stock: 22, current_stock: 22 },
  { id: 'stk-7-chambre', sku: 'SERV-BAIN-CHMB', name: 'Serviettes de bain (En Chambre)', category_id: 'Linge en Chambre', supplier_id: 'sup-2', purchase_price: 5000, selling_price: 0, unit: 'Pièce', minimum_stock: 22, current_stock: 22 },
...
export const mockStockMovements: IStockMovement[] = [
  {
    id: 'mvt-1',
  ...
  },
  {
    ...
    item_id: 'stk-3-sale',
    item_name: 'Draps Plat Coton (Linge Sale / Buanderie)',
    sku: 'DRAP-CTN-SALE',
    quantity: 1,
    from_location: 'Chambre 101',
    to_location: 'Linge Sale (Buanderie)',
    staff_name: 'Awa (Housekeeping)',
    type: 'Envoi Buanderie'
  },
  {
    id: 'mvt-4',
    timestamp: '2026-07-14 02:15:00',
    item_id: 'stk-4',
    item_name: 'Ampoule LED E27 9W',
    sku: 'AMP-LED-9W',
    quantity: 2,
    from_location: 'Stock Général',
    to_location: 'Chambre 203',
    staff_name: 'Abdoulaye (Technicien)',
    type: 'Maintenance Chambre'
  }
];
