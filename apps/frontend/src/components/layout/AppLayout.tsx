          ...
          <div className="flex items-center space-x-3 lg:space-x-6">
            ...
            <div className="flex bg-white/10 p-1 rounded-lg text-[10px] font-bold border border-white/5">
              <button
                ...
                className={`px-2 py-1 rounded-md transition-all ${currency === 'XOF' ? 'bg-brand-orange text-white shadow-xs' : 'text-white/60 hover:text-white'}`}
              >
                FCFA (XOF)
              </button>
              <button
                onClick={() => setCurrency('EUR')}
                className={`px-2 py-1 rounded-md transition-all ${currency === 'EUR' ? 'bg-brand-orange text-white shadow-xs' : 'text-white/60 hover:text-white'}`}
              >
                EUR (€)
              </button>
            </div>
